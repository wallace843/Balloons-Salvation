...
public class BalloonsJogo implements Screen {
	...
	private BalloonsObjeto[] objetos;
    ...
    public BalloonsJogo(Game game) {
        ...
        this.controller = new BalloonsController(game);
        this.objetos = controller.gerarObjetos();
        this.camera = new OrthographicCamera(Gdx.graphics.getWidth()*3, Gdx.graphics.getHeight()*3);
